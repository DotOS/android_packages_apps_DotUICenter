...
import com.dot.uicenter.bottom_fragments.overlay_engine.CE_Overlay_Showcase_Black;
import com.dot.uicenter.bottom_fragments.overlay_engine.CE_Overlay_Showcase_Dark;
import com.dot.uicenter.bottom_fragments.overlay_engine.CE_Overlay_Showcase_Light;
...
public class OverlayEngine_Fragment extends Fragment {
    ...
    public void updateFABTheme(String theme) {
        FloatingActionButton apply_overlay = getActivity().findViewById(R.id.main_fab);
